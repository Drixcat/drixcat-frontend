...
function DownloadBrochure({onClose,onSubmitForm,actualCourse,slug}) {
  ...
  const selectPlatform = ['Instagram','Facebook','Google','Friends','School/College','Others']
...
const downloadPDF = (fileName) => {
  ...
  const handleSubmitQuery = async (e) => {
    ...
    try {
      ...
      setFormData({ name: '', email: '', phone: '', trainingMode: '', currentProfile:'', course: slug, suggestedBy: '' });
      setIsLoading(false);
      downloadPDF(`${slug}.pdf`)
    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 overflow-y-auto p-4 sm:p-6 md:p-8">
      ...
      >
        ...
        <form className="space-y-4 text-sm" onSubmit={handleSubmitQuery}>
          ...
          <div>
            <label className="block text-[#808098] mb-1">How Did You Hear About Us??</label>
            {/* <textarea
